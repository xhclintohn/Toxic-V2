    ...
    run: async (context) => {
        ...
        await client.sendMessage(m.chat, { react: { text: '⌛', key: m.reactKey } });
            ...
            try {
                ...
                if (!jids.length) return client.sendMessage(m.chat, { text: BOX('DEMOTEALL', ['No admins to demote (other than me).']) });

                await client.sendMessage(m.chat, { text: BOX('DEMOTEALL', [`Demoting ${jids.length} admin(s)...`]) });
